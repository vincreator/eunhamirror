...
rawowners = "<h1 style='text-align: center'>See my Channel <a href='https://t.me/Eunha_Mirror'>@Telegram</a><br><br>By<br><br><a href='https://github.com/vincreator'>Vincreator</a></h1>"
...
<body>
    ...
    <header>
        <div class="brand">
            <img src="https://telegra.ph/file/b490985ebdef513f8b206.png" alt="logo" />
        </div>
        <h2 class="name">Qbittorrent Selection</h2>
        <div class="social">
            <a href="https://www.github.com/vincreator"><i class="fab fa-github"></i></a>
            <a href="https://t.me/Eunha_Mirror"><i class="fab fa-telegram"></i></a>
        </div>
    </header>
    <!-- pin_entry -->
    <!-- files_list -->
