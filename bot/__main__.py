...
help_string = f'''
Catatan: Coba setiap perintah tanpa awalan apa pun untuk melihat detail lebih lanjut.
/{BotCommands.MirrorCommand[0]} or /{BotCommands.MirrorCommand[1]}: Mulai mirroring ke Google Drive.
/{BotCommands.ZipMirrorCommand[0]} or /{BotCommands.ZipMirrorCommand[1]}: Mulai mirroring dan unggah file/folder dikompresi dengan ekstensi zip.
/{BotCommands.UnzipMirrorCommand[0]} or /{BotCommands.UnzipMirrorCommand[1]}: Mulai mirroring dan unggah file/folder yang diekstraksi dari ekstensi arsip apa pun.
/{BotCommands.QbMirrorCommand[0]} or /{BotCommands.QbMirrorCommand[1]}: Mulai mirroring ke Google Drive menggunakan QBitTorrent.
/{BotCommands.QbZipMirrorCommand[0]} or /{BotCommands.QbZipMirrorCommand[1]}: Mulai Mirroring Menggunakan QBitTorrent dan Unggah File/Folder Terkompresi dengan Ekstensi Zip.
