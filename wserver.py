...
<body>
<h1>Eunha-Mirror-bot: <a href="https://github.com/vincreator/Eunha-Mirror-bot">@Github</a></h1>
...
async def list_torrent_contents(request):
    ...
    rend_page = rend_page.replace("{form_url}",f"/eunha/files/{torr}?pin_code={pincode}")
    client.auth_log_out()
    return web.Response(text=rend_page,content_type='text/html')
  ...
  async def middleware_handler(request):
      ...
      try:
          ...
          if response.status == 404:
              return web.Response(text="<h1>404: Page not found</h2><br><h3>eunha</h3>",content_type="text/html")
          return response
